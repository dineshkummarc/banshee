...
{
    public class TrackListDatabaseModel : TrackListModel, IFilterable, ISortable, ICareAboutView
    {
        private Dictionary<int, LibraryTrackInfo> tracks = new Dictionary<int, LibraryTrackInfo>();
        
        private BansheeDatabase database;
        private int rows;
        ...
        public TrackListDatabaseModel(BansheeDatabase database)
        {
        ...
        private void GenerateSortQueryPart()
        {
            ...
            sort_query = String.Format(" {0} {1} ", sort_query, 
                sort_column.SortType == Gtk.SortType.Ascending ? " ASC" : " DESC");
        }
        ...
        public void Sort(ISortableColumn column)
        {
            lock(this) {
                if(sort_column == column && sort_column != null) {
                    sort_column.SortType = sort_column.SortType == Gtk.SortType.Ascending 
